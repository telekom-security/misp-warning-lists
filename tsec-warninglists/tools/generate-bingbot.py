...
def process(file, dst):
    warninglist = {
        'name': "List of the official Bingbot IP ranges",
        'version': '',
        'description': "List of the official Bingbot IP ranges (https://www.bing.com/webmasters/help/how-to-verify-bingbot-3905dc26)",
        'type': "cidr",
        'list': [],
